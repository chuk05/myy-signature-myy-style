        ...
        <div className="max-w-2xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="bg-white rounded-lg shadow-sm p-8 text-center">
            ...
            <div className="space-y-4">
              <a
                href="/"
                className="inline-block bg-[#6A8EA4] text-white py-3 px-8 rounded-lg font-semibold hover:bg-[#5a7a90]"
              >
                Back to Home
              </a>
              <br />
              <a
                href="/booking"
                className="inline-block bg-[#F0F0F0] text-[#222222] py-3 px-8 rounded-lg font-semibold hover:bg-gray-200"
              >
